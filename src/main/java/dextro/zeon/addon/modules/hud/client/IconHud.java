package dextro.zeon.addon.modules.hud.client;
...
public class IconHud extends HudElement {
    private static final Identifier LOGO = new Identifier("zeon", "icon.png");
    ...
    public IconHud(HUD hud) {
        super(hud, "zeon-logo", "Displays a logo of ZEON Addon.");
    }

    @Override
    public void update(HudRenderer renderer) {
        box.setSize(78 * scale.get(), 78 * scale.get());
    }
